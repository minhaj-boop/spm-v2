...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-olive navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="head.php" class="nav-link">Home</a>
      </li>
  </nav>
  <!-- /.navbar -->
  ...
  <div class="float-right d-none d-sm-block">
    ...
    <strong>Copyright &copy; 2021 <a href="head.php">SPM</a>.</strong> All rights reserved.
  </footer>
</div>
